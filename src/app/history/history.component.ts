...
@Component({
  ...
  standalone: true,
  imports: [CalendarModule, FormsModule, NgForOf, KeyValuePipe, NgIf, KnobModule],
...
export class HistoryComponent implements OnInit {
  ...
  public onClose(): void {
    if (this.date) {
      ...
      this.dataRequests.sendRangedDateMeals(URL_DEFAULT + '/api/get_meals_filtered/', requestOptions, {
